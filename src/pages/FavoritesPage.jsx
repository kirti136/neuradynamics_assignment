...
import { selectFavorites, clearAllFavorites } from '../features/favorites/favoritesSlice'
    ...
    return (
      <div className="text-center py-16">
        ...
        <p className="text-gray-400 mb-8 max-w-md mx-auto">
          ...
          Browse our products and click the heart icon to add items.
        </p>
        <Link 
          to="/products" 
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-400">
            {favorites.length} {favorites.length === 1 ? 'product' : 'products'} in your favorites list
          </p>
        </div>
        <button 
